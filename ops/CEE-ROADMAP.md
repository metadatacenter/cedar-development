...
- **The local frontends run ahead of what is published.** All four — the Template
  ...
  `1.6.0-dev.20260809.3b0d307`, which carries the application builder, the
  conformance spec, the current model library and the static image dimensions.
  Nothing published carries those yet, and openview needs its paired change before
  a release that does.

...
Constraint arrows reorder entries within their kind; term exclusions and result
positions are separate actions. `selectionMode = 'term'` retains single-term output

...
- **19. Let the rebuilt search index become searchable before `regenerate-search-index` swaps the
...
- **20. Publish a library snapshot before the consumer that needs it is built, or make the consumer

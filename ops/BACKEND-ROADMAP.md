...
- **29. Resolve the remaining production artifact defects and review semantic migrations.**
  ...
  **Resolve the remaining production instance sources and pipeline findings.** The retained
  findings and checked repairs leave 55 affected instances.
  ...
  to the 55-instance baseline. Account for their stricter-reader rejection before production
  ...
  | Malformed/empty stored URI is the first Java rejection | 30 |
